...
// */
//public class DirectionsQuery extends AsyncTask<String, String, DirectionsResponse> {
//
...
//
//    private static HashMap<String, DirectionsResponse> directionsCache = new HashMap<>(4);
//
...
//
//    @Override
//    protected DirectionsResponse doInBackground(String... travelModes) {
//        // first check if we already have this one cached
//        String cacheKey = addressKey + travelModes[0];
//        DirectionsResponse cachedDirectionsResponse = directionsCache.get(cacheKey);
...
//        }
//
//        // DirectionsResponse is not cached; go query for directions.
...
//                DirectionsResponse gsonObj = gson.fromJson(ir, DirectionsResponse.class);
//                ir.close();
//                inputStream.close();
//
...
//        }
//
//        if (!directionsResponse.status.equals("OK")) {
//            Log.e(TAG, "Directions query directionsResponse status is: " + directionsResponse.status);
//            showError();
//
//            return;
//        }
...
//        Route foundRoute = directionsResponse.routes.get(0);
//
